        ...
        return <div className="component-wrapper">
            <div className="page-wrapper">
                <div className="beer-item">
                    <div className="button button_info beer-item__nav-button" onClick={this.goToList}>Back</div>
                    {this.props.isLoading && <Loader/>}
                    {this.props.error && <div className="alert alert_danger beer-item__error">{this.props.error}</div>}
